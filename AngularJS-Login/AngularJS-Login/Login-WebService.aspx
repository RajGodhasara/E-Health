        ...
        mymodal.controller('MainCtrl', function ($scope,$http) {
            ...
            $scope.auth = function () {
                ...
                $http({ method: "GET", url: "LoginService.asmx/Authentication", params: { email: $("#email").val(), pass: $("#pass").val() } })
                        ...
                        .then(function (response) { $scope.ans = response.data; alert("ans"+ans.value); });
            ...
            $scope.insert = function () {
                ...
                $http({ method: "GET", url: "LoginService.asmx/Insert", params: { Email:$("#email").val() , Pass:$("#pass").val()  } })
                    .error(function (status) { alert(status) })
                    .then(function (response) { $scope.ans = response.data; alert(ans); });
            };
        });
...
<body ng-app="mymodal">
   <form id="form1" runat="server">
       <asp:Button ID="Button1" CssClass="btn btn-default" runat="server" Text="List Using Gridview" OnClick="list_using_grid"></asp:Button>
       <table>
